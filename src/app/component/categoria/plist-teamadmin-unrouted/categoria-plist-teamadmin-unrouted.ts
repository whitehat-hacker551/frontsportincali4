...
@Component({
  selector: 'app-categoria-plist-teamadmin-unrouted',
  imports: [BotoneraRpp, Paginacion, RouterLink, BotoneraActionsPlist],
  templateUrl: './categoria-plist-teamadmin-unrouted.html',
  styleUrl: './categoria-plist-teamadmin-unrouted.css',
  standalone: true,
})
export class CategoriaPlistTeamAdminUnrouted {
  ...
  private dialogRef = inject(MatDialogRef<CategoriaPlistTeamAdminUnrouted>, { optional: true });
